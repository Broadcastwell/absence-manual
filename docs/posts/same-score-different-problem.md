...
**Measured, Volume II.** The relationship survives that small base being removed. Visibility against absence-is-comparison runs at r = 0.234, p = 4.1 × 10⁻⁹ across all 616 records, and excluding the top tier entirely it still holds at r = 0.184, p = 5.9 × 10⁻⁶, n = 600.
